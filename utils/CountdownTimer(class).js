            ...
            function countDownRECURSIVO(){
                ...
                if(contenedorSegundos){
                    ...
                    if(animation){
                        ...
                        .then(()=>{
                            setTimeout(()=>{
                                desvanecerElementoConScale(contenedorSegundos,duracionDeAnimacionEnSegundos)
                ...
                if(tiempoInicial==((include0)?0:1)){
                    ...
                    setTimeout(()=>{
                        ...
                        if(!textoFinal){
                            setTimeout(()=>{resolve()},ADDITIONAL_SECONDS*1000*playBackRate);
                            return;
                        }
                        ...
                        if(styleMapForTextFinal){
                            ...
                            estilosParaTextoFinalElement = insertarReglasCSSAdicionales(estilos);
                        ...
                        .then(()=>{
                            setTimeout(()=>{                                
                                desvanecerElementoConScale(contenedorSegundos,duracionDeAnimacionEnSegundos).animation.finished
                                    .then(()=>{
                                        setTimeout(() => {                                                                  
                                            if(estilosParaTextoFinalElement) eliminarReglasCSSAdicionales(estilosParaTextoFinalElement);
                                            resolve();
